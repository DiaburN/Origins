...
function showDropdown(element,resolved){
  ...
  dropdown.style.background='#000';dropdown.style.border=`1px solid ${PRIMARY}`;dropdown.style.overflow='auto';dropdown.style.zIndex='10000';
