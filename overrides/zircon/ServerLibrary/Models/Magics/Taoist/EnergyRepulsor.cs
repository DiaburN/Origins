...
{
    [MagicType(MagicType.EnergyRepulsor)]
    public sealed class EnergyRepulsor : MagicObject
    {
        protected override Element Element => Element.None;
        public override bool UpdateCombatTime => false;

        public EnergyRepulsor(PlayerObject player, UserMagic magic) : base(player, magic) { }
