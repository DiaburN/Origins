...
{
    [MagicType(MagicType.GreateFireBallSecret)]
    public sealed class GreateFireBallSecret : MagicObject
    {
        protected override Element Element => Element.Fire;

        public GreateFireBallSecret(PlayerObject player, UserMagic magic) : base(player, magic)
        {
        }
