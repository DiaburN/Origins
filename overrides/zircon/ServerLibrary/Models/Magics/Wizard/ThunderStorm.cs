...
{
    [MagicType(MagicType.ThunderStorm)]
    public class ThunderStorm : MagicObject
    {
        protected override Element Element => Element.Lightning;

        public ThunderStorm(PlayerObject player, UserMagic magic) : base(player, magic)
        {
        }
        ...
        public override void MagicComplete(params object[] data)
        {
            ...
            foreach (Cell cell in CurrentMap.GetCells(center, 0, 2))
            {
                ...
                for (int i = cell.Objects.Count - 1; i >= 0; i--)
                {
                    ...
                    bool undead = ob is MonsterObject monster && monster.MonsterInfo.Undead;
                    int power = undead ? castPower : castPower / 10;
        ...
        {
            // Crystal trains ThunderStorm once per 5x5 cast.
        }
