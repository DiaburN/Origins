...
def main():
 ...
 loop=spec.get('constructorLoopInventory') or {};final=spec.get('finalSupplementalSourceMatrix') or {};fail=[]
 ...
 print(f'Final constructor-loop coverage: PASS -> loops={loop.get("loopCount")}, unexpected deterministic=0')
