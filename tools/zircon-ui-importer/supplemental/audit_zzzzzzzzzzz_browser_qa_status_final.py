...
def main():
 ...
 print('Final Browser QA status publisher: PASS -> branch-safe exact-SHA CI evidence readable as commit status; source floor remains pending until success')
