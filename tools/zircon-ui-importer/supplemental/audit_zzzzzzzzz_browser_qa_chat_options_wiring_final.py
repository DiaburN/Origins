...
def main() -> None:
    ...
    required_workflow = (
        ...
        "zero={'listItems':0,'panels':0,'tabControls':0,'chatTabs':0}",
        "one={'listItems':1,'panels':1,'tabControls':1,'chatTabs':1}",
        "chat.get('before') != zero",
        "chat.get('afterAdd') != one",
        "chat.get('afterRemove') != zero",
        "chat.get('checkboxes') != 16",
        "chat.get('manifestControlsAdded') != 0",
        "chat.get('runtimePayloadsInvented') is not False",
    ...
    report = {
        ...
        'removeClearsLocalTree': "chat.get('afterRemove') != zero" in workflow and 'remove.click()' in runtime,
        'manifestControlsAdded': 0,
        'runtimePayloadsInvented': False,
